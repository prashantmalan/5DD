...
export class DashboardPanel {
  ...
  static show(context: vscode.ExtensionContext, stats: StatsTracker): DashboardPanel {
  ...
  private getHtml(initial: SessionStats): string {
  ...
  private inlineHtml(s: SessionStats): string {
    return `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
